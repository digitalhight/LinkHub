...
export const ConfigModal: React.FC<ConfigModalProps> = ({ isOpen }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 animate-in fade-in zoom-in duration-300 overflow-y-auto max-h-[90vh]">
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-900">Configuration WomenCards</h2>
